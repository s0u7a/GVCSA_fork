...
public class RenderB_BulletFire<T extends EntityB_BulletFire> extends Render<T>
{
    private final RenderItem itemRenderer;
    //private final RenderManager rendermanager;

    public RenderB_BulletFire(RenderManager renderManagerIn, RenderItem itemRendererIn)
    {
    ...
    {
    		return new ItemStack(mod_GVCLib.e_fire);
    }
