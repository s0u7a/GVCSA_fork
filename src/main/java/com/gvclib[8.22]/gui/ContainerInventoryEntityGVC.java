...
public class ContainerInventoryEntityGVC extends Container
{
    ...
    public ContainerInventoryEntityGVC(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        ...
        this.addSlotToContainer(new Slot(furnaceInventory, 1, 20, 35));
        this.addSlotToContainer(new Slot(furnaceInventory, 2, 38, 17));
        this.addSlotToContainer(new Slot(furnaceInventory, 3, 38, 53));
        this.addSlotToContainer(new Slot(furnaceInventory, 4, 38, 35));
        ...
        this.addSlotToContainer(new Slot(furnaceInventory, 5, 116, 35));
        this.addSlotToContainer(new Slot(furnaceInventory, 6, 134, 35));
        this.addSlotToContainer(new Slot(furnaceInventory, 7, 152, 35));
        this.addSlotToContainer(new Slot(furnaceInventory, 8, 116, 53));
        this.addSlotToContainer(new Slot(furnaceInventory, 9, 134, 53));
        this.addSlotToContainer(new Slot(furnaceInventory, 10, 152, 53));
